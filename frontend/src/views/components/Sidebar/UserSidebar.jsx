          ...
          <div class="sidebar-menu-list">
            <div class="list-group list-group-messages">
              <a href="#" class="list-group-item list-group-item-action active">
                ...
                <span class="badge badge-light-primary rounded-pill float-end">
                  3
                </span>
              </a>
              ...
              <a href="#" class="list-group-item list-group-item-action">
                ...
                <span class="badge badge-light-warning rounded-pill float-end">
                  2
                </span>
              </a>
              <a href="#" class="list-group-item list-group-item-action">
              ...
              <a href="#" class="list-group-item list-group-item-action">
                ...
                <span class="badge badge-light-danger rounded-pill float-end">
                  5
                </span>
              </a>
              <a href="#" class="list-group-item list-group-item-action">
            ...
            <div class="list-group list-group-labels">
              ...
              <a href="#" class="list-group-item list-group-item-action">
                <span class="bullet bullet-sm bullet-primary me-1"></span>
                Company
              </a>
              <a href="#" class="list-group-item list-group-item-action">
